...
(module* main #f
  ...
  (add 10 (make-scheme-number 5))
  (sub 10 (make-scheme-number 5))
  (mul 10 (make-scheme-number 5))
  (div 10 (make-scheme-number 5))
  (equ? 10 (make-scheme-number 10))
  ...
  (equ? (make-complex-from-real-imag 10 20) (make-complex-from-mag-ang 10 3.1415926))
